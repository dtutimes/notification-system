import notification_system, { InformationUpdate, Configuration } from "notification-system";
import fs from "node:fs";


function save_request(data: InformationUpdate) {
